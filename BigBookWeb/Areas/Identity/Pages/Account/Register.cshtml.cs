...
namespace BigBookWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            if (!_roleManager.RoleExistsAsync(StaticDetails.Role_User_Individual).GetAwaiter().GetResult())
            {
